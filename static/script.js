...
window.openUploadModal = async function(inputId) {
    ...
    try {
        const response = await fetch('/saved-faces');
...
document.getElementById('videoForm').addEventListener('submit', async (e) => {
    ...
    try {
        const response = await fetch('/swap-video', { method: 'POST', body: formData });
        const data = await response.json();
...
document.getElementById('addFaceInput').addEventListener('change', async function(e) {
    ...
    for (let file of files) {
        ...
        try {
            await fetch('/save-face', { method: 'POST', body: formData });
        } catch (error) {
...
document.getElementById('multiTargetInput').addEventListener('change', async function(e) {
    ...
    try {
        const response = await fetch('/detect-faces', { method: 'POST', body: formData });
        const data = await response.json();
...
document.getElementById('multiSwapBtn').addEventListener('click', async () => {
    ...
    try {
        ...
        const response = await fetch('/swap-multi', { method: 'POST', body: formData });
        const data = await response.json();
